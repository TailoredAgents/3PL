            ...
            <div className="mt-5 grid gap-4">
              {load.carrierCandidates.length ? (
                ...
                <p className="rounded-md border border-dashed border-slate-200 bg-slate-50 p-5 text-sm leading-6 text-slate-600">
                  ...
                  carriers found through DAT, Truckstop, relationships, texts,
                  or dispatch calls before requesting quotes.
                </p>
              )}
            </div>
          </section>
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-5 grid gap-4">
              {load.carrierQuotes.length ? (
                ...
                <p className="rounded-md border border-dashed border-slate-200 bg-slate-50 p-5 text-sm leading-6 text-slate-600">
                  No carrier offers yet. Add offers as dispatchers call back,
                  then accept the best compliant option.
                </p>
              )}
            </div>
          </section>
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-5 grid gap-3">
              {load.integrationLogs.length ? (
                ...
                <p className="rounded-md border border-dashed border-slate-200 bg-slate-50 p-5 text-sm leading-6 text-slate-600">
                  No marketplace activity yet. Search capacity or post this load
                  to DAT/Truckstop to create an audit log.
                </p>
              )}
            </div>
          </section>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="grid gap-6">
            ...
            <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Log BOLs, PODs, rate confirmations, invoices, and other load
                documents. Upload a file directly or add a name to record the
        ...
        <section className="grid gap-6 xl:grid-cols-2">
          ...
          <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-semibold">Billing readiness</h2>
            </div>
            ...
            <p className="mt-6 rounded-md bg-slate-50 px-3 py-2 text-sm font-semibold text-slate-700">
              Current billing state: {load.billingReadiness}
            </p>
